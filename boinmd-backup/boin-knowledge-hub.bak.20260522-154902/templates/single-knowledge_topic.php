...
$tinnitus_scenes = array(
    array( 'title' => '晚上耳鸣特别明显', 'url' => '/knowledge/tinnitus/night-tinnitus/' ),
    array( 'title' => '安静时耳鸣更明显', 'url' => '/knowledge/tinnitus/quiet-room-tinnitus/' ),
    array( 'title' => '一只耳朵耳鸣', 'url' => '/knowledge/tinnitus/one-ear-ringing/' ),
    array( 'title' => '耳朵像蝉叫', 'url' => '/knowledge/tinnitus/cicada-sound/' ),
    array( 'title' => '耳朵嗡嗡响', 'url' => '/knowledge/tinnitus/buzzing-sound/' ),
    array( 'title' => '耳鸣影响睡眠', 'url' => '/knowledge/tinnitus/sleep/' ),
);

$tinnitus_questions = array(
    array( 'q' => '耳鸣越来越严重怎么办？', 'a' => '耳鸣感受变化可能与作息、压力、噪音暴露和听力状态有关。建议先记录出现时间和场景，并结合听力测试进一步判断。', 'url' => '/knowledge/tinnitus/worsening-tinnitus/' ),
    array( 'q' => '晚上耳鸣特别明显是怎么回事？', 'a' => '夜晚环境更安静时，外界声音减少，耳鸣更容易被注意到。部分人也会在疲劳和睡眠不足时感受更明显。', 'url' => '/knowledge/tinnitus/night-tinnitus/' ),
    array( 'q' => '一只耳朵耳鸣正常吗？', 'a' => '单侧耳鸣并不少见，但持续存在或伴随听不清、眩晕等情况时，建议尽早做专业评估。', 'url' => '/knowledge/tinnitus/one-ear-ringing/' ),
    array( 'q' => '耳鸣和听力下降有关吗？', 'a' => '不少耳鸣人群同时存在不同程度听力下降。耳鸣不等于一定听损，但两者可能同时影响沟通与生活质量。', 'url' => '/knowledge/tinnitus/hearing-loss/' ),
    array( 'q' => '耳鸣会自己好吗？', 'a' => '部分人群在调整作息、减少噪音刺激后可能会减轻，但变化因人而异，持续耳鸣建议结合听力评估判断。', 'url' => '/knowledge/tinnitus/self-relief/' ),
    array( 'q' => '戴助听器对耳鸣有帮助吗？', 'a' => '对部分伴随听力下降的人群，合适的声音放大和干预可能有助于减轻耳鸣困扰，需结合个体情况评估。', 'url' => '/knowledge/tinnitus/hearing-aid-help/' ),
);
...
<main class="bkh-page bkh-topic">
  ...
  <section class="bkh-block bkh-scenes">
    <div class="bkh-wrap">
      <h2 class="bkh-section-title">你是哪一种耳鸣情况？</h2>
      <div class="bkh-scene-grid bkh-scene-grid-2col">
        <?php foreach ( $tinnitus_scenes as $s ) : ?>
          <a class="bkh-scene-card" href="<?php echo esc_url( bkh_url( $s['url'] ) ); ?>">
            <h3 class="bkh-scene-title"><?php echo esc_html( $s['title'] ); ?></h3>
          </a>
        <?php endforeach; ?>
      </div>
    </div>
  ...
  <section id="tinnitus-questions" class="bkh-block bkh-tinnitus-questions">
    <div class="bkh-wrap">
      <h2 class="bkh-section-title">耳鸣常见问题</h2>
      <div class="bkh-hot-grid">
        <?php foreach ( $tinnitus_questions as $q ) : ?>
          <a class="bkh-hot-card" href="<?php echo esc_url( bkh_url( $q['url'] ) ); ?>">
            <span class="bkh-hot-q"><?php echo esc_html( $q['q'] ); ?></span>
  ...
  <section class="bkh-block bkh-tinnitus-factors">
    <div class="bkh-wrap">
      <h2 class="bkh-section-title">耳鸣可能与这些因素有关</h2>
      <div class="bkh-topic-grid">
        <article class="bkh-topic-card"><h3 class="bkh-topic-name">听力下降相关</h3><p class="bkh-topic-desc">当外界声音输入减少时，大脑可能会对声音信号变得更敏感。</p></article>
        <article class="bkh-topic-card"><h3 class="bkh-topic-name">长期噪音暴露</h3><p class="bkh-topic-desc">长时间处于高噪音环境，可能增加听觉系统负担。</p></article>
        <article class="bkh-topic-card"><h3 class="bkh-topic-name">疲劳与睡眠不足</h3><p class="bkh-topic-desc">熬夜、压力大、睡眠差时，部分人会感觉耳鸣更明显。</p></article>
        <article class="bkh-topic-card"><h3 class="bkh-topic-name">安静环境放大感受</h3><p class="bkh-topic-desc">夜晚或安静房间里，外界声音减少，耳鸣更容易被注意到。</p></article>
      </div>
    </div>
  </section>

  <section class="bkh-block bkh-tinnitus-relation">
    <div class="bkh-wrap bkh-wrap-text">
      <h2 class="bkh-section-title">耳鸣和听力下降有什么关系？</h2>
      <p class="bkh-hero-sub">不少耳鸣人群同时存在不同程度的听力下降。耳鸣不等于一定听损，但如果伴随听不清说话、电视声音越开越大、嘈杂环境交流困难，建议尽早做一次听力评估。</p>
      <div class="bkh-compare-card">
        <p><strong>耳鸣：</strong>听到不存在的声音感受</p>
        <p><strong>听力下降：</strong>对外界声音接收变弱</p>
        <p><strong>共同点：</strong>都可能影响沟通、睡眠和情绪</p>
        <p><strong>建议：</strong>结合听力测试判断具体情况</p>
      </div>
      <p><a class="bkh-btn bkh-btn-primary" href="<?php echo esc_url( bkh_url( '/knowledge/hearing-loss/' ) ); ?>">了解听力下降</a></p>
    </div>
  </section>

  <section class="bkh-block bkh-tinnitus-tips">
    <div class="bkh-wrap">
      <h2 class="bkh-section-title">耳鸣明显时，可以先尝试这些方式</h2>
      <div class="bkh-tip-grid">
        <div class="bkh-tip-card">避免长时间完全安静</div>
        <div class="bkh-tip-card">减少强噪音刺激</div>
        <div class="bkh-tip-card">保持规律作息</div>
        <div class="bkh-tip-card">记录耳鸣出现时间和场景</div>
        <div class="bkh-tip-card">关注是否伴随听力下降</div>
        <div class="bkh-tip-card">必要时进行听力测试</div>
      </div>
      <p class="bkh-disclaimer">以上内容仅作科普参考，不替代专业诊断或治疗建议。若耳鸣持续存在或明显影响生活，建议咨询专业人员。</p>
    </div>
  </section>
  <?php endif; ?>

  <?php if ( ! empty( $scenes ) && ! $is_tinnitus ) : ?>
  <section class="bkh-block bkh-scenes">
    <div class="bkh-wrap">
      <h2 class="bkh-section-title">常见场景</h2>
      <div class="bkh-scene-grid">
        <?php foreach ( $scenes as $s ) : $link = $s['scene_link'] ?? ''; ?>
          <?php if ( $link ) : ?><a class="bkh-scene-card" href="<?php echo esc_url( $link ); ?>"><?php else : ?><div class="bkh-scene-card"><?php endif; ?>
            <?php if ( ! empty( $s['scene_icon'] ) ) : ?><span class="bkh-scene-icon"><?php echo esc_html( $s['scene_icon'] ); ?></span><?php endif; ?>
  ...
  <section class="bkh-block bkh-content">
    <div class="bkh-wrap bkh-wrap-text"><?php echo $content; ?></div>
  </section>
  <?php endif; ?>

  <?php if ( ! empty( $reasons ) && ! $is_tinnitus ) : ?>
  ...
  if ( $is_tinnitus ) :
      $faq_entities = array();
      foreach ( $tinnitus_questions as $f ) {
          $faq_entities[] = array(
              '@type' => 'Question',
  ...
  if ( $cat_slug ) {
      ...
      <section class="bkh-block bkh-related">
        <div class="bkh-wrap">
          <h2 class="bkh-section-title"><?php echo esc_html( $is_tinnitus ? '更多耳鸣相关内容' : '本专题相关文章' ); ?></h2>
          ...
          <?php else : ?>
            <p class="bkh-empty">更多耳鸣内容正在整理中，稍后将持续更新。</p>
          <?php endif; ?>
        </div>
      </section>
      <?php
  ...
  <section class="bkh-bottom-nav">
    <div class="bkh-wrap">
      <h2 class="bkh-section-title bkh-section-title-sm">继续了解相关听力问题</h2>
    ...
    <div class="bkh-wrap">
      <div class="bkh-cta-inner">
        <div class="bkh-cta-text">
          <h2 class="bkh-cta-title">如果耳鸣伴随听不清，建议先了解听力情况</h2>
          <p class="bkh-cta-desc">耳鸣和听力下降有时会同时出现。通过听力评估，可以更清楚地了解自己的听力状态，再判断是否需要进一步干预或助听方案。</p>
        </div>
        <div class="bkh-cta-actions">
          <a class="bkh-btn bkh-btn-primary" href="<?php echo esc_url( bkh_url( '/knowledge/hearing-loss/' ) ); ?>">了解听力评估</a>
          <a class="bkh-btn bkh-btn-ghost" href="<?php echo esc_url( $products_url ); ?>">查看助听器方案</a>
        </div>
      </div>
    </div>
  </section>
